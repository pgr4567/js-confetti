...
function normalizeConfettiConfig(confettiConfig) {
  var _confettiConfig$confe = confettiConfig.confettiRadius,
    ...
    confettiNumber = _confettiConfig$confe2 === void 0 ? confettiConfig.emojis ? DEFAULT_EMOJIS_NUMBER : DEFAULT_CONFETTI_NUMBER : _confettiConfig$confe2,
    ...
    emojis = _confettiConfig$emoji === void 0 ? [] : _confettiConfig$emoji,
...
var JSConfetti = /*#__PURE__*/function () {
  ...
  _createClass(JSConfetti, [{
    ...
    key: "addConfetti",
    value: function addConfetti(confettiConfigs) {
      ...
      var _iterator = _createForOfIteratorHelper(confettiConfigs),
        _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var config = _step.value;
          var _normalizeConfettiCon = normalizeConfettiConfig(config),
          ...
          for (var i = 0; i < confettiNumber / 2; i++) {
            var confetti = new ConfettiShape({
              initialPosition: getPos(config.confettiPosition || {
                x: 0,
                y: 0.5
              }),
              direction: config.confettiDirection || 'right',
              confettiRadius: confettiRadius,
              confettiColors: confettiColors,
              confettiNumber: confettiNumber,
              emojis: emojis,
            ...
            confettiGroup.addShapes(confetti);
          }
        }
      } catch (err) {
        _iterator.e(err);
